"""Step 15 — 5-anchor stack with Qwen LoRA (out-of-family, r ~0.88).
...
OUT = ROOT / "outputs" / "step15_qwen_5anchor_stack"
OUT.mkdir(parents=True, exist_ok=True)
SUBMIT_DIR = ROOT / "outputs" / "submissions"
DATA_DIR = ROOT / "data" / "raw"

ANCHOR_FILES = {
    "qwen":    ROOT / "outputs/qwen_lora_finetune_outputs/qwen_lora_finetune",
...
def main():
    ...
    for label, w in pick_specs:
        ...
        sub_path = SUBMIT_DIR / f"next_qwen_5anchor_{label}_submission.csv"
    ...
    print(f"Public-validated (E5 safest_e5, 0.72394): e5=0.50 scincl=0.30 specter=0.20 ridge=0.00  OOF=0.6593 test_L1=0.142")
    for s in summary:
        w = s["weights"]
